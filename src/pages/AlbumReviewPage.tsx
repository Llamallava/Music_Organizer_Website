    ...
    <main className="flex h-screen flex-col overflow-hidden px-6 py-4">
      <div className="mx-auto flex min-h-0 w-full max-w-[1500px] flex-1 flex-col">
        ...
        <section className="mt-4 grid min-h-0 flex-1 gap-4 lg:grid-cols-[280px_minmax(0,1fr)_320px]">
          ...
          <section className="flex min-h-0 flex-col rounded-xl border border-slate-200 bg-white p-4">
            <div className="mb-3 flex items-start justify-between gap-3">
              ...
              <div className="flex items-end gap-3">
                {showSavedMark && <span className="pb-1 text-lg text-emerald-500">✓</span>}
                {isDirty && !isSaving && <p className="pb-1 text-xs text-amber-700">Unsaved changes</p>}
                {activeTrack && (
                ...
                <div ref={actionsMenuRef} className="relative">
                  ...
                  {isActionsMenuOpen && (
                    <div className="absolute right-0 top-full z-20 mt-1 w-56 overflow-hidden rounded-xl border border-slate-200 bg-white p-1 shadow-lg">
                      {activeTrack && (
                        <button
                          type="button"
                          onClick={() => {
            ...
            <textarea
              ...
              className="min-h-0 flex-1 w-full resize-none rounded-lg border border-slate-300 p-3 text-sm leading-relaxed text-slate-900"
            />
          ...
          <aside className="flex min-h-0 flex-col rounded-xl border border-slate-200 bg-white p-4">
              ...
              isEditingLyrics ? (
                <>
                  <textarea
                    ...
                    className="min-h-0 flex-1 w-full resize-none rounded-lg border border-slate-300 p-2 text-sm leading-relaxed text-slate-900"
                  />
                  {lyricsErrorMessage && (
